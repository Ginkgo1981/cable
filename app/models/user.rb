...
class User < ApplicationRecord
  ...
  def daily_promotion
    ...
    # [["9628d2a9-8e03-4512-9cd1-264b64795333", "小王子"],
    ...
    #  ["93f8d156-0c6f-4db3-bb24-2602f7c26f02", "美食话题(7天)"]]
      ...
      payload =
          {
              ...
              miniprogram:{
                  ...
                  pagepath: 'pages/campaign-promotion-page/campaign-promotion-page?id=cb60a2ad-586a-4640-914c-54c78584ad47'
              },
              data:{
                  first: {
                      value: first_value
